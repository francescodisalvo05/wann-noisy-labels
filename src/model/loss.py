# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# code from: https://github.com/Virusdoll/Active-Negative-Loss/blob/main/loss.py
# paper: https://openreview.net/pdf?id=Uafbv4rfJc (NIPS, 23)
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
class ActiveNegativeLoss(torch.nn.Module):
    def __init__(self, active_loss, negative_loss, alpha=1., beta=1., delta=0.) -> None:
        super().__init__()
        self.active_loss = active_loss
...
# ELR was not available in the previous open-source codebase.
# Thus, I used the official implementation.
# https://github.com/shengliu66/ELR/blob/master/ELR/model/loss.py

class ELR(nn.Module):
    def __init__(self, num_examp, num_classes=10, beta=0.3, lam=3):
