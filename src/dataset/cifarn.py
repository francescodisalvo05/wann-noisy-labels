# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # src: https://github.com/UCSC-REAL/cifar-10-100n/blob/main/data/cifar.py
# # authors: Jiaheng Wei, Zhaowei Zhu, Hao Cheng, Tongliang Liu, Gang Niu, and Yang Liu
# # paper: https://openreview.net/pdf?id=TBWA6PLJZQm
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
class CIFAR10N(data.Dataset):
    ...
    def __init__(self, root, train=True,
        ...
        if self.train:
            ...
            if noise_type !='clean':
                ...
                print('overall noise rate is ', self.actual_noise_rate * 100)
                #print('\t>> Noise rate is ', self.actual_noise_rate)
        else:
    ...
    def __getitem__(self, index):
        ...
        # small variation, index first position instead of the last one!!
